...
public class WidMultiActionTextView extends AppCompatTextView {
    ...
    public WidMultiActionTextView(Context context) {
        super(context);
        initView(context, null);
    }

    public WidMultiActionTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public WidMultiActionTextView(Context context, AttributeSet attrs, int defStyleAttr) {
