package com.huayun.lib_widget.wid_radius_img;
...
public class ImageViewRadius extends AppCompatImageView {
    ...
    public ImageViewRadius(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.ImageViewRadiusStyle);
    }
    ...
    public ImageViewRadius(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(
                attrs, R.styleable.ImageViewRadius, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.ImageViewRadius_iv_borderWidth, 0);
        mBorderColor = array.getColor(R.styleable.ImageViewRadius_iv_borderColor, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.ImageViewRadius_iv_selectedBorderWidth, mBorderWidth);
        mSelectedBorderColor = array.getColor(
                R.styleable.ImageViewRadius_iv_selectedBorderColor, mBorderColor);
        mSelectedMaskColor = array.getColor(
                R.styleable.ImageViewRadius_iv_selectedMaskColor, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(
                R.styleable.ImageViewRadius_iv_isTouchSelectModeEnabled, true);
        mIsCircle = array.getBoolean(R.styleable.ImageViewRadius_iv_isCircle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.ImageViewRadius_iv_isOval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(
                    R.styleable.ImageViewRadius_iv_cornerRadius, 0);
            roundTopLeft = array.getBoolean(R.styleable.ImageViewRadius_iv_roundTopLeft, true);
            roundTopRight = array.getBoolean(R.styleable.ImageViewRadius_iv_roundTopRight, true);
            roundBottomRight = array.getBoolean(R.styleable.ImageViewRadius_iv_roundBottomRight, true);
            roundBottomLeft = array.getBoolean(R.styleable.ImageViewRadius_iv_roundBottomLeft, true);
        }
