package com.huayun.lib_widget.wid_edittext.edit_pwd;
...
public class WidSplitEditTextView extends AppCompatEditText{
    ...
    private void initAttrs(Context c, AttributeSet attrs) {
        ...
        mBorderSize = array.getDimension(R.styleable.WidSplitEditTextView_borderSize, UnitUtil.dp2px(c,1f));
        ...
        mDivisionLineSize = array.getDimension(R.styleable.WidSplitEditTextView_divisionLineSize, UnitUtil.dp2px(c,1f));
        mDivisionColor = array.getColor(R.styleable.WidSplitEditTextView_divisionLineColor, Color.BLACK);
        mCircleRadius = array.getDimension(R.styleable.WidSplitEditTextView_circleRadius, UnitUtil.dp2px(c,5f));
        ...
        mSpaceSize = array.getDimension(R.styleable.WidSplitEditTextView_spaceSize, UnitUtil.dp2px(c,10f));
        mTextSize = array.getDimension(R.styleable.WidSplitEditTextView_android_textSize, UnitUtil.sp2px(c,16f));
        ...
        mCursorWidth = array.getDimension(R.styleable.WidSplitEditTextView_cursorWidth, UnitUtil.dp2px(c,2f));
